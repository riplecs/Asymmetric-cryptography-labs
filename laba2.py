...
if __name__=='__main__':
    ...
    if check['verified']:
        ...
        print('\nЦифровий підпис невірний!')
    print('\nСпробуємо тепер спотворити повідомлення після підписання, і '
          'подивимось, що станеться: ')
    sign_M, sign = signed_mess
    print('\nЗмінюємо повідомлення і надсилаємо його разом із цифровим підписом..')
    sign_M += 1520245324
    print('\nЦП: ', int(sign))
    print('\nПовідолення:',  sign_M)
    print('\nЮзер В перевіряє правильність цифрового підпису...')
    if Verify((sign_M, sign), A_public_key):
        print('\nВерифікація пройшла успішно!')
    else:
        print('\nЦифровий підпис невірний!')
